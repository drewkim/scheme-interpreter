...
(eval (define bar (+ (* 3 3) (- 9 6))))
; expect 12
(quote (1 . '(2 3)))
; expect (1 quote (2 3))

'(1 2 (3 . 4) (quote (2 . 3)))
; expect (1 2 (3 . 4) (quote (2 . 3)))
(begin (+ 5 3) (- (* 2 2) 1) (/ 1 1))
; expect 1

(begin (define x 9) (print x) (define x 10) (print x) (/ 8 2))
; expect 9 ; 10 ; 4
(begin (define y 6) (print x) (print y) y)
; expect 10 ; 6 ; 6

(lambda (i j) (* i (+ i j) (- i j)))
; expect (lambda (i j) (* i (+ i j) (- i j)))

(define f (lambda (i j) (* i (+ i j) (- i j))))
; expect f
(f 10 8)
; expect 360
...
(define x 8)
; expect x
(and (and 6 (= x 8) (or 6 (equals x 7))))
; expect 6
(or (or 0 0 False 1) (and 0 0 False 1))
; expect 0

(cond ((= 0 0) 1) (else (/ 1 0)))
; expect 1
(cond ((= x 7) 'no) ((= x 6) 'no) (else 12))
; expect 12
...
(let ((x 100)) (+ 1 x))
; expect 101
(let ((x 1) (undeclared_variable 1)) (+ x undeclared_variable))
; expect 2
